...
public class JoiningBatchService {
    ...
    private JoiningBatchResponse toResponse(JoiningBatch batch, boolean includeMembers) {
        ...
        return JoiningBatchResponse.builder()
                ...
                .joiningDate(batch.getJoiningDate())
                .joiningLocationId(batch.getJoiningLocation() != null ? batch.getJoiningLocation().getId() : null)
                .joiningLocationName(batch.getJoiningLocation() != null ? batch.getJoiningLocation().getName() : null)
                .trainingLocationId(batch.getTrainingLocation() != null ? batch.getTrainingLocation().getId() : null)
